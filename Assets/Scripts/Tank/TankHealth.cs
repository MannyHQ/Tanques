...
public class TankHealth : MonoBehaviour
 ...
 public Color m_FullHealthColor = Color.green; //Color del slider consalud completa (verde)
 public Color m_ZeroHealthColor = Color.red; //Color del slider consalud vacía (rojo)
 ...
 // Si la salud es menor que 0 y aún no lo he explotado, llamo almétodo OnDeath (al morir).
